...
module.exports = {
  ...
  excludeFiles: [
     /\.(ios|wp).(scss)$/i,
     /(grid|split-pane|badge|card|checkbox|chip|datetime|fab|img|note|picker|range|refresher|loading|segment|select|show-hide-when|slides|tabs|virtual-scroll|cordova)/i,
